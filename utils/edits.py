...
PROJECT_DUE_DATES = {
    ...
    ("DA Section 1A", "portfolio project: an intel data center"): datetime(2025, 11, 30),
    ("DA Section 1B", "portfolio project: an intel data center"): datetime(2025, 11, 30),
    ("DA Section 2A", "portfolio project: an intel data center"): datetime(2025, 11, 16),
    ("DA Section 2B", "portfolio project: an intel data center"): datetime(2025, 11, 16),
    ("DA Section 2C", "portfolio project: an intel data center"): datetime(2025, 11, 16),
    ("DC Section 1A", "portfolio project: analyzing website data with the grammys"): datetime(2025, 11, 30),
    ("DC Section 1B", "portfolio project: analyzing website data with the grammys"): datetime(2025, 11, 30),
    ("DC Section 2A", "portfolio project: analyzing website data with the grammys"): datetime(2025, 11, 16),
    ("DC Section 2B", "portfolio project: analyzing website data with the grammys"): datetime(2025, 11, 16),
    ("DC Section 2C", "portfolio project: analyzing website data with the grammys"): datetime(2025, 11, 16),
